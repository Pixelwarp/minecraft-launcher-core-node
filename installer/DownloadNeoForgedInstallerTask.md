# Class DownloadNeoForgedInstallerTask
...
```ts
new DownloadNeoForgedInstallerTask(version: string, minecraft: MinecraftFolder, options: InstallForgeOptions): DownloadNeoForgedInstallerTask
```
#### Parameters
...
<strong>Defined in:</strong> <a href="https://github.com/voxelum/minecraft-launcher-core-node/blob/master/packages/installer/neoForged.ts#L14" target="_blank" rel="noreferrer">packages/installer/neoForged.ts:14</a>
</p>
...
```
<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/voxelum/minecraft-launcher-core-node/blob/master/packages/installer/neoForged.ts#L12" target="_blank" rel="noreferrer">packages/installer/neoForged.ts:12</a>
</p>
